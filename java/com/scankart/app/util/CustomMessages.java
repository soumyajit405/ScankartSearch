...
public class CustomMessages {
	...
	public static String getCustomMessages(String code)
	{
		...
		else if(code.equalsIgnoreCase("OC"))
		{
			return "Order Completed/Paid. So cannot be cancelled.";
		}
		...
		else if(code.equalsIgnoreCase("OAV"))
		{
		...
		else if(code.equalsIgnoreCase("WOT"))
		{
			return "Wrong Confirmation OTP.";
		}
		...
		else if(code.equalsIgnoreCase("NDF"))
		{
